...
function colorMode() {
  if (actualMode === "black") {
    ...
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mouseover", colorEraser)
    );
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mouseover", colorColors)
    );
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mouseover", colorRainbow)
    );
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mousedown", colorColors)
    );
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mousedown", colorRainbow)
    );
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mousedown", colorEraser)
    );
    ...
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mousedown", colorBlack)
    );
    miniGrids.forEach((grid) =>
      grid.removeEventListener("mousedown", colorRainbow)
    );
    ...
    miniGrids.forEach((grid) =>
      grid.addEventListener("mouseover", colorColors)
    );
    miniGrids.forEach((grid) =>
      grid.addEventListener("mousedown", colorColors)
    );
    ...
    miniGrids.forEach((grid) =>
      grid.addEventListener("mouseover", colorRainbow)
    );
    miniGrids.forEach((grid) =>
      grid.addEventListener("mousedown", colorRainbow)
    );
    ...
    miniGrids.forEach((grid) =>
      grid.addEventListener("mouseover", colorEraser)
    );
    miniGrids.forEach((grid) =>
      grid.addEventListener("mousedown", colorEraser)
    );
  }
}
